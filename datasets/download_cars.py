...
target_path_train = '/content/drive/MyDrive/dataset/data/cars/cars_train.tgz'
target_path_test = '/content/drive/MyDrive/dataset/data/cars/cars_test.tgz'
devkit_path = '/content/drive/MyDrive/dataset/data/cars/devkit'
...
tar.extractall(path='/content/drive/MyDrive/dataset/data/cars')
tar.close()
