...
path = '/content/drive/MyDrive/dataset/data/cars/dataset/'
...
class_names = scipy.io.loadmat('/content/drive/MyDrive/dataset/data/cars/devkit/cars_meta.mat')
...
mat = scipy.io.loadmat('/content/drive/MyDrive/dataset/data/cars/devkit/cars_train_annos.mat')
...
mat = scipy.io.loadmat('/content/drive/MyDrive/dataset/data/cars/devkit/cars_test_annos_withlabels.mat')
# print(mat['annotations'])
testing_class = mat['annotations']['class']
testing_fname = mat['annotations']['fname']

training_source = '/content/drive/MyDrive/dataset/data/cars/cars_train/' # specify source training image path
...
testing_source = '/content/drive/MyDrive/dataset/data/cars/cars_test/' # specify source testing image path
